      ...
      tdiv(class = "stats-grid"):
        ...
        tdiv(class = "stats-panel stats-panel-wide"):
          ...
          if statsData.largestPackages.len == 0:
            ...
            p(class = "help-text"):
              text "Packages sorted by total tarball size across all versions. Large tarballs often indicate bundled binaries, vendored third-party dependencies, unexcluded assets, or test data not kept under a tests/ directory — all worth investigating."
